        ...
        <div className='px-3 py-1'>
            <div className='flex flex-row gap-3'>
                {testcases.map((testcase, index) => (
                    <button className={`px-3 py-2 rounded-lg text-sm flex flex-row justify-center hover:bg-neutral-700 items-center gap-1 ${selectedCase === index ? "bg-neutral-700" : "bg-neutral-800"}`} onClick={() => setSelectedCase(index)}>
