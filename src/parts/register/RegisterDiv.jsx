...
const RegisterDiv = () => {
    ...
    const onGoogleLogin = () => {
        ...
        const params = {
            ...
            redirect_uri: `https://leetclone-backend.azurewebsites.net/${REDIRECT_URI}`,
            ...
            <div className="p-4 sm:p-7">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-600 dark:text-neutral-400">
                        ...
                        <a className="text-blue-600 decoration-2 hover:underline font-medium dark:text-blue-500" href="/login">
                            &nbsp;Sign in here
                        </a>
                    </p>
                </div>
                ...
                <div className="mt-5">
                    <form>
                        <div className="grid gap-y-4">
                            ...
                            <button onClick={onSubmitClick} type="button" className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">Sign up</button>
                        </div>
                    </form>
