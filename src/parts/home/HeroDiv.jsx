        ...
        <div class="relative overflow-hidden before:absolute before:top-0 before:start-1/2 dark:bg-black before:bg-no-repeat before:bg-top before:bg-cover before:size-full before:-z-[1] before:transform before:-translate-x-1/2 bg-white">
            <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-10">
                ...
                <div class="mt-5 max-w-3xl text-center mx-auto">
                    <p class="text-lg text-gray-600 dark:text-neutral-400">Join our community of developers and enhance your coding skills with our comprehensive problem-solving platform.</p>
                </div>
                ...
                <div class="mt-8 gap-3 flex justify-center">
                    ...
                    <button className='px-3 py-2 hover:outline hover:outline-violet-600 rounded-md text-gradient-to-tl from-blue-600 to-violet-600 dark:text-white'>
                        Learn More
                    </button>
                </div>
            </div>
